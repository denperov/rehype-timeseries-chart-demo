...
//   • containerClass          – CSS class on the wrapping <div> (default "csv-line-chart")
...
/* ------------------------------------------------------------------ */
export default function rehypeCsvLineChartSvg(options = {}) {
  const {
    width,
    height,
    title,
